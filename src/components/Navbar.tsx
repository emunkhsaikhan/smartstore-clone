...
const Navbar = () => {
  return (
    <header className="hidden 2xl:flex w-full flex-col mx-auto">
      {/* TOPBAR SECTION */}
      <div className="bg-secondary_purple h-10 w-full flex items-center justify-center text-[13px] text-white px-4">
